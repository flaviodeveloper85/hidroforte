<div class="container-fluid">
    <div class="row">
        <img src="<?php echo base_url();?>img/acessorios.jpg" class="img-responsive" width="1440" height="413" alt="banheira individual" />
            ...
            <div class="container-modal-prod" id="container-modal-prod">
                    <div class="row">
                        ...
                        <div class="col-lg-6 info-prod">
                            ...
                            <a class="btn-sm btn-default bt-prod-orc" class="bt-acessorios" href="<?php echo site_url(); ?>contato">Fazer Pedido</a>
                        </div>
                    </div>
            </div> 
...
<script>
    ...
    // funçao para mostrar detalhes dos produtos
