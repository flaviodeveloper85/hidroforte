<div class="container-fluid">
    <div class="row">
        <img src="<?php echo base_url();?>img/ofuro.jpg" class="img-responsive" width="1440" height="413" alt="ofuro" />
    <div class="container banheiras">
        ...
        <div class="products" onclick="info_prod(<?php echo $data->id; ?>)">
            <img src="<?php echo base_url('img/uploads/');?><?php echo $data->imagem?>" width="200" height="200" alt="ofuro">
